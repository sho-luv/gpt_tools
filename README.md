...
- [`goldengmsa`](goldengmsa/README.md): A cross-platform Impacket tool for
  enumerating Golden gMSA material, identifying permitted readers, retrieving
  KDS root keys, and computing gMSA credentials offline.
...
GoldenGMSA has its own [installation, authentication, and workflow
documentation](goldengmsa/README.md).
