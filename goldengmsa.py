...
@app.command()
def gmsainfo(
    target: Annotated[str, typer.Argument(help="domain/username[:password]")],
    ...
    hashes: Annotated[str | None, typer.Option(help="LMHASH:NTHASH for NTLM authentication.")] = None,
    no_pass: Annotated[bool, typer.Option("--no-pass", help="Do not prompt for a password.")] = False,
    kerberos: Annotated[bool, typer.Option("-k", "--kerberos", help="Use Kerberos and the current ccache.")] = False,
    aes_key: Annotated[str | None, typer.Option(help="AES key for Kerberos authentication.")] = None,
    dc_ip: Annotated[str | None, typer.Option(help="Domain controller IP address.")] = None,
    dc_host: Annotated[str | None, typer.Option(help="Domain controller hostname.")] = None,
) -> None:
    ...
    try:
        ...
        for record in records:
            ...
            safe_target = f"{credentials.domain}/{credentials.username}" if credentials.username else credentials.domain
            _print_command(
...
def compute(
    ...
    target: Annotated[
        str | None,
        typer.Argument(help="domain/username[:password] for missing inputs."),
    ] = None,
